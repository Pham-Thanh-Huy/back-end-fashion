...
import com.example.backendfruitable.DTO.ProductSizeDTO;
import com.example.backendfruitable.entity.ProductSize;
import com.example.backendfruitable.repository.ProductSizeRepository;
...
public class ProductSizeService {
    ...
    public BaseResponse<Page<ProductSizeDTO>> getAllProductSizes(Pageable pageable) {
        ...
        try{
            ...
            for(ProductSize productSize : productSizePage.getContent()){
    ...
    public BaseResponse<ProductSizeDTO> updateProductSize(Integer productSizeId, ProductSizeDTO productSizeDTO){
        BaseResponse<ProductSizeDTO> baseResponse = new BaseResponse<>();
        try{
            Optional<ProductSize> productSizeOptional = productSizeRepository.findById(productSizeId);
            if(!productSizeOptional.isPresent()){
